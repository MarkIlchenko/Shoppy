...
const NavButton = ({ title, customFunc, icon, color, detColor }) => (
    <TooltipComponent content={title} position="BottomCenter">
        <button type="button" onClick={customFunc} style={{color}} className="relative text-xl rounded-full p-3 hover:bg-light-gray">
            <span style={{ background: detColor }}
    ...
    return (
        <div className="flex justify-between p-2 md:mx-6 relative">
            ...
            <div className="flex">
                ...
                <NavButton title="Chat" dotColor="#03C9D7" customFunc={() => handleClick('chat')} detColor="#03C9D7" color={currentColor} icon={<BsChatLeft />} />
                <NavButton title="Notification" dotColor="#03C9D7" customFunc={() => handleClick('notification')} detColor="#03C9D7" color={currentColor} icon={<RiNotification3Line />} />
                <TooltipComponent
                    content="Profile"
